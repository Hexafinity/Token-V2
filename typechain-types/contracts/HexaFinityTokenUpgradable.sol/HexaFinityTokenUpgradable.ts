...
export interface HexaFinityTokenUpgradableInterface extends utils.Interface {
  functions: {
...
export interface HexaFinityTokenUpgradable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HexaFinityTokenUpgradableInterface;
