...
async function main() {
  ...
  */
  ...
  const taxReceiverAddress =
    '0xB3baAc32C0D7b2266043bF735467FFFCbf746f50'; // temp tax receiver address
  // const taxReceiverAddress = "0xdbb5633eee15f0649d8747e6f65abdf0078c264a"; // tax receiver address

  // Start Deploying
  console.log('Deploying contracts with the account...');

  const HexaFinityToken = await ethers.getContractFactory(
    'HexaFinityTokenUpgradable',
  );
  const hfToken = await upgrades.deployProxy(HexaFinityToken, [
    routerAddress,
    taxReceiverAddress,
  ]);
